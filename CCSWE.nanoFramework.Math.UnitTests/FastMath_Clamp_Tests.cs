...
{
    [TestClass]
    public class FastMath_Clamp_Tests
    {
        #region Double
        [TestMethod]
        public void Clamp_Double_returns_max_when_value_is_greater_than_max()
        {
            Assert.AreEqual(1d, FastMath.Clamp(10d, -1d, 1d));
        }

        [TestMethod]
        public void Clamp_Double_returns_max_when_value_is_NaN()
        {
            Assert.AreEqual(1d, FastMath.Clamp(float.NaN, -1d, 1d));
        }
        ...
        {
            Assert.ThrowsException(typeof(ArgumentException), () => { FastMath.Clamp(10d, 1d, 0d); });
        }

        [TestMethod]
        public void Clamp_Double_throws_when_max_is_NaN()
        {
            Assert.ThrowsException(typeof(ArgumentException), () => { FastMath.Clamp(10d, 1d, double.NaN); });
        }
        ...
        {
            Assert.AreEqual(1f, FastMath.Clamp(10f, -1f, 1f));
        }

        [TestMethod]
        public void Clamp_Float_returns_max_when_value_is_NaN()
        {
            Assert.AreEqual(1f, FastMath.Clamp(float.NaN, -1f, 1f));
        }
        ...
        {
            Assert.ThrowsException(typeof(ArgumentException), () => { FastMath.Clamp(10f, 1f, 0d); });
        }

        [TestMethod]
        public void Clamp_Float_throws_when_max_is_NaN()
        {
            Assert.ThrowsException(typeof(ArgumentException), () => { FastMath.Clamp(10f, 1f, float.NaN); });
        }
        ...
        {
            Assert.AreEqual(1L, FastMath.Clamp(10L, -1L, 1L));
        }
        ...
        {
            Assert.ThrowsException(typeof(ArgumentException), () => { FastMath.Clamp(10L, 1L, 0L); });
        }
        #endregion
        ...
        {
            Assert.AreEqual(1L, FastMath.Clamp(10UL, 0UL, 1UL));
        }

        [TestMethod]
        public void Clamp_ULong_returns_min_when_value_is_less_than_min()
        {
            Assert.AreEqual(5L, FastMath.Clamp(0L, 5L, 10L));
        }
